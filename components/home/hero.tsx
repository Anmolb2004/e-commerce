...
export function Hero() {
  ...
  return (
    <section className="relative isolate overflow-hidden">
      {/* Soft radial wash — kept behind the content so it never veils text */}
      <div
        aria-hidden
        className="pointer-events-none absolute -top-40 right-[-10%] -z-10 size-[42rem] rounded-full bg-blush/50 blur-3xl"
      />
